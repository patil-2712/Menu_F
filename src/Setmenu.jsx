      ...
      <div className="main-content">
        ...
        <div className="content-header">
          <div className="header-info">
            <h1><FaUtensils /> Menu Management</h1>
            <p className="restaurant-subtitle">{restaurantData?.restaurantName || restaurant?.restaurantName || 'Restaurant'} • {restaurantData?.restaurantCode || restaurant?.restaurantCode || 'N/A'}</p>
          </div>
          <button className="refresh-btn" onClick={fetchMenu}>
            <FaSpinner className={loading ? 'spinner' : ''} /> Refresh
          </button>
        </div>
